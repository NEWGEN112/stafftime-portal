...
if (isLoggedIn()) {
    header('Location: ../admin/index.php'); // later we will make staff dashboard
    exit;
}
        ...
        <form method="POST" action="">
          <div class="mb-3">
            ...
            <input type="text" name="email_or_phone" class="form-control" required 
                   placeholder="Enter email or phone" value="<?php echo htmlspecialchars($_POST['email_or_phone'] ?? ''); ?>">
          </div>
